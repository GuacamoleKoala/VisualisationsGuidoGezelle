    ...
    if (f.attributes) {
        ...
        for (var i = 0; i < priorityOrder.length; i++) {
            ...
            if (f.attributes[attrKey] !== undefined && attrKey !== image_attribute) {
                ...
                var attributeValueHtml = d; // Standaard de ruwe waarde
                
                
                // Maak de HTML string
                var h = '<span><strong>' + attrKey + ':</strong> ' + attributeValueHtml + '</span>'; 
        ...
        // De thumbnail-weergave (deze is ook verbeterd in de nieuwe code)
        if (image_attribute) {
        ...
        // Dit zorgt ervoor dat elk attribuut op een nieuwe regel begint.
